...
<a href="http://www.gwrra.org/" target="_blank"><img border="0" src="config/gwrra_logo_100.gif" alt="Gold Wing Road Riders Association"></a>&nbsp; 
</div>
<div id="headerImgLogo">
<a href="./"><img border="0" src="config/Logo-100.gif" alt="<%=g_sSiteName%>"></a> 
</div>
